...
curl -X POST -s http://127.0.0.1:40005/v1/completions -H "Content-Type: application/json" -d '{"model": "deepseek-ai/DeepSeek-R1","prompt": "the us is ?","max_tokens": 10,"temperature": 0, "top_k":1}' | awk -F'"' '{print $22}'
